      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-indigo-400">Travel Agency</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Destinations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Adventure Tours</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Cultural Experiences</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Luxury Travel</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Group Tours</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Custom Packages</Link></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-indigo-400">Contact Info</h4>
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-300 text-sm">123 Travel Street<br />Adventure City, AC 12345</p>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@travelagency.com</p>
              </div>
            </div>
          </div>
        </div>
